        ...
        p = function (F, G) {
            ...
            if (CKEDITOR.plugins.link.emptyAnchorFix) {
                ...
                for (i = 0, count = Z.count(); i < count; i++) {
                    Y = Z.getItem(i);
                    if (Y.data('cke-saved-name') || Y.hasAttribute('name')) X.push({
                        name: Y.data('cke-saved-name') || Y.getAttribute('name'),
            ...
            if (CKEDITOR.plugins.link.fakeAnchor) {
                ...
                for (ab = 0, ac = ad.count(); ab < ac; ab++) {
                    if (Y = CKEDITOR.plugins.link.tryRestoreFakeAnchor(F, ad.getItem(ab))) X.push({
                        name: Y.getAttribute('name'),
                        id: Y.getAttribute('id')
                    });
                }
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    ...
                    html: '<div role="label" tabIndex="-1">' + CKEDITOR.tools.htmlEncode(E.noAnchors) + '</div>',
                    focus: true,
                    setup: function (F) {
